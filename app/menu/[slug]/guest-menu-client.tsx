...
import { Clock, Plus, Search, Utensils, CheckCircle, Loader2, X, ChevronRight, MessageSquare } from "lucide-react";
...
export default function GuestMenuClient({ initialLocation, initialCategories }: GuestMenuClientProps) {
